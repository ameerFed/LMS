...
export default function ResetPassword() {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      const res = await dispatch(resetPasswordAPI(obj)).unwrap();
      if (res.success) {
  ...
  return (
    <div className="d-flex flex-column flex-grow-1 justify-content-center px-15">
      <div className="text-center mb-20">
        <h1 className="ah-heading-02 fw-semibold mb-3">Reset Password</h1>
        <p className="black-100 ah-text-base">Please enter your new Password</p>
      </div>
      <Formik
